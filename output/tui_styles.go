...
const (
	...
	footerText  = "scroll: ↑/↓ | paging: PgUp/PgDn/Home/End | cancel: q/Esc/Ctrl+C"
	footerDone  = "✓ All done! " + "scroll: ↑/↓ | paging: PgUp/PgDn/Home/End" + " | print output: p | quit: Enter/Esc or q"
	footerVim   = "\n\t(also supports Vim keybinds)"
